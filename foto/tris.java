...
public class tris {
    ...
    public static void impiccato() {
        ...
        String[] cittàIta = { "milano", "taranto", "monopoli", "firenze", "massa carrara", "forte dei marmi",
                ...
                "treviso", "gressonei", "aosta", "ancona", "civitanova", "jesolo", "senigallia",
        ...
        System.out.println(stringacat + " " + parola);
        ...
        while (rip < 10) {
            ...
            System.out.println("\n\n"
                    + "-Vuoi inserire la parola completa --> inserire '1'\n-Vuoi provare a inserire una lettera --> inserire '2'\n");
            int parolaolettera = in20.nextInt();
            ...
            switch (parolaolettera) {
                case 1:
                    ...
                    String parolaoinserita = in21.nextLine();
                ...
                case 2:
                    ...
                    String letterainserita = in22.nextLine();
                    int cont = 0;
                    int cont2 = 0;
            ...
            if (errore == 3) {
                System.out.println("CATEGORIA: " + stringacat);
            }
